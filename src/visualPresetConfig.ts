...
export const PRESETS_IMAGES: Record<string, string> = {
  // 彩平图/3D轴测图
  cp_realistic: '/presets/thumbs/写实风格.webp',
  cp_watercolor: '/presets/thumbs/水彩手绘风格.webp',
  cp_flat: '/presets/thumbs/扁平插画风格.webp',
  cp_lightcolor: '/presets/thumbs/淡彩风格.webp',
  cp_dark: '/presets/thumbs/暗黑模式.webp',
  cp_vintage: '/presets/thumbs/复古风格.webp',

  // 效果图/风格替换
  xg_modern_luxury: '/presets/thumbs/现代轻奢.webp',
  xg_modern_simple: '/presets/thumbs/现代北欧.webp',
  xg_modern_italian: '/presets/thumbs/现代意式.webp',
  xg_modern_nordic: '/presets/thumbs/现代北欧.webp',
  xg_modern_wood: '/presets/thumbs/现代原木.webp',
  xg_midcentury: '/presets/thumbs/中古风.webp',
  xg_oldmoney: '/presets/thumbs/复古老钱.webp',
  xg_french_cream: '/presets/thumbs/法式奶油.webp',
  xg_modern_cream: '/presets/thumbs/现代奶油风.webp',
  xg_french: '/presets/thumbs/法式风格.webp',
  xg_newchinese: '/presets/thumbs/新中式风格.webp',
  xg_japanese: '/presets/thumbs/日式风格.webp',
  xg_song: '/presets/thumbs/宋氏风格.webp',
  xg_wabi: '/presets/thumbs/侘寂风格.webp',
  xg_morandi: '/presets/thumbs/莫兰迪风格.webp',
  xg_industrial: '/presets/thumbs/工业风格.webp',
  xg_mediterranean: '/presets/thumbs/波西米亚风格.webp',
  xg_bohemian: '/presets/thumbs/波西米亚风格.webp',
  xg_tropical: '/presets/thumbs/热带度假风.webp',

  // 光影替换
  gy_direct: '/presets/thumbs/自然光直射.webp',
  gy_diffuse: '/presets/thumbs/漫射天光.webp',
  gy_sidelight: '/presets/thumbs/侧光掠射.webp',
  gy_backlight: '/presets/thumbs/逆光剪影.webp',
  gy_wallwash: '/presets/thumbs/洗墙照明.webp',
  gy_warm: '/presets/thumbs/暖色调氛围光.webp',
  gy_rembrandt: '/presets/thumbs/伦勃朗光.webp',

  // 分镜生成
  fj_storyboard: '/presets/thumbs/写实风格.webp',

  // 汇报图
  hb_analysis: '/presets/thumbs/写实风格.webp',
  hb_board: '/presets/thumbs/写实风格.webp',
  hb_mood: '/presets/thumbs/水彩手绘风格.webp',
  hb_explode: '/presets/thumbs/扁平插画风格.webp',

  // 360全景
  qj_panorama: '/presets/thumbs/写实风格.webp',
};
